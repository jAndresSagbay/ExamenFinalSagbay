...
a persistence unit "ExamenProveedor1JEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenProveedor1JEE\pom.xml":
...
artifact ("ExamenProveedor1JEE.war") is already built. You can build
