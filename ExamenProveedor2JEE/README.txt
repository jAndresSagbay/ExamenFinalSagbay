...
a persistence unit "ExamenProveedor2JEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenProveedor2JEE\pom.xml":
...
artifact ("ExamenProveedor2JEE.war") is already built. You can build
