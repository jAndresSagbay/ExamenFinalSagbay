...
a persistence unit "ExamenFerreteriaJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenFerreteriaJEE\pom.xml":
...
artifact ("ExamenFerreteriaJEE.war") is already built. You can build
